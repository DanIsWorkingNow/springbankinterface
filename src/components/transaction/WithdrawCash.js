...
const WithdrawCash = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.amount) {
      ...
      if (isNaN(amount) || amount <= 0) {
        ...
        errors.amount = 'Maximum daily withdrawal limit is $50,000';
      } else if (amount < 0.01) {
        errors.amount = 'Minimum withdrawal amount is $0.01';
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await transactionAPI.withdrawCash({
        accountNumber: formData.accountNumber.trim(),
        amount: parseFloat(formData.amount),
        description: formData.description.trim() || 'Cash withdrawal'
      });
  ...
  if (loading) {
    return <LoadingSpinner message="Processing your withdrawal..." />;
  }
  ...
  return (
    <div className="withdraw-cash">
      <div className="withdraw-header">
        <h2>💳 Withdraw Cash</h2>
        <p>Withdraw funds from your account securely</p>
      </div>
      ...
      <div className="warning-notice">
        ...
        <div className="warning-content">
          ...
          <p>Please ensure sufficient funds are available in your account. 
             Transactions cannot be reversed once processed. Daily withdrawal limit: $50,000.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="withdraw-form">
        ...
        <div className="form-group">
          ...
          <small className="help-text">Minimum: $0.01 | Daily Limit: $50,000</small>
        </div>
      ...
      <div className="withdraw-info">
        ...
        <ul>
          <li>Withdrawals are processed immediately and deducted from your account</li>
          <li>Ensure sufficient balance before attempting withdrawal</li>
          <li>Transaction fees may apply based on your account type</li>
          <li>Daily withdrawal limits apply for security purposes</li>
